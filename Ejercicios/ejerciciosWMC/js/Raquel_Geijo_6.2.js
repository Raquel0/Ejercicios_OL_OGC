...
function init() {
    ...
    //CUANDO HAGA CLICK SE EJECUTA LA FUNCION creaPopUp y la calcularArea
...
function creaPopUp(evento) {
    ...
    if (selectedFeature) {
        ...
        var area = selectedFeature.getGeometry().getArea().toFixed(4);
        ...
        var texto = "<p><strong>Sup:</strong> " + area + "km2" + "<br/>"
